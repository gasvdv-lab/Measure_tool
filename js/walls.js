...
import {S,getPoint,getLine} from "./state.js?v=0.8.36.4.2-20260830-stability-audit";
import {dispose,renderPosition} from "./geometry.js?v=0.8.36.4.2-20260830-stability-audit";
