...
export async function loadThree(){
  ...
  const T=S.THREE;tmpPos=new T.Vector3();tmpQuat=new T.Quaternion();up=new T.Vector3(0,1,0);camPos=new T.Vector3();camQuat=new T.Quaternion();forward=new T.Vector3();
}
function init(){
