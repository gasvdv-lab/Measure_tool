...
import {enforceLocked,updateLabels,updatePointLabels,updateMarkerScale,clearAllGeometry} from "./geometry.js?v=0.8.36.2-20260830-direction-angle-repair";
import {updateCandidate,updatePreviewScreen,isCaptureAllowed,resetDrawingCore} from "./drawing-core.js?v=0.8.36.2-20260830-direction-angle-repair";
import {clearWalls,syncWorldLockedWalls} from "./walls.js?v=0.8.36.2-20260830-direction-angle-repair";
import {configureWorldLock,updateWorldLock,resetWorldLock} from "./world-lock.js?v=0.8.36.2-20260830-direction-angle-repair";
import {updateCadFrame,clearCadRuntime} from "./cad.js?v=0.8.36.2-20260830-direction-angle-repair";
