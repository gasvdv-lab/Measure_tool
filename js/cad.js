import {S,projectToWorld,worldToProject} from "./state.js?v=0.8.28.2-20260829-2100";
...
export async function importCadFile(file){
  ...
  if(!/\.(glb|gltf)$/i.test(file.name))throw new Error("v0.8.28.2 ondersteunt GLB/glTF. Exporteer FreeCAD eerst als GLB/glTF.");
