...
import {snapshotProject,restoreProject,clearHistory} from "./history.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {clearAllGeometry,validateGeometryState} from "./geometry.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {clearWalls} from "./walls.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {resetDrawingCore} from "./drawing-core.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {detachAllPointAnchors} from "./world-lock.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {clearCadRuntime,restoreCadRuntime} from "./cad.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {clearAiBuilderObjects} from "./ai-builder.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {clearClearances} from "./clearance.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
