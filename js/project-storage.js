...
import {snapshotProject,restoreProject,clearHistory} from "./history.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
import {clearAllGeometry,validateGeometryState} from "./geometry.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
import {clearWalls} from "./walls.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
import {resetDrawingCore} from "./drawing-core.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
import {detachAllPointAnchors} from "./world-lock.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
import {clearCadRuntime,restoreCadRuntime} from "./cad.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
import {clearAiBuilderObjects} from "./ai-builder.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
import {clearClearances} from "./clearance.js?v=0.8.36.2.2-20260830-capture-rearm-fix";
