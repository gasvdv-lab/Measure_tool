import {startAR} from "./ar.js?v=0.8.14-20260822-2130";
import {$} from "./state.js?v=0.8.14-20260822-2130";
const VERSION="0.8.14",BUILD="20260822-2130";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.14-20260822-2130");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
