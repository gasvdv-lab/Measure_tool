import {startAR} from "./ar.js?v=0.8.28.3-20260829-2125";
import {$} from "./state.js?v=0.8.28.3-20260829-2125";
const VERSION="0.8.28.2",BUILD="20260829-2125";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.28.3-20260829-2125");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
