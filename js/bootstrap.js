import {startAR} from "./ar.js?v=0.8.11-20260822-1945";
import {$} from "./state.js?v=0.8.11-20260822-1945";
const VERSION="0.8.11",BUILD="20260822-1945";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.11-20260822-1945");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
