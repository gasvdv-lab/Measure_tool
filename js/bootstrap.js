import {startAR,resumeARFromGesture} from "./ar.js?v=0.8.30-20260830-measure-engine-foundation";
import {$} from "./state.js?v=0.8.30-20260830-measure-engine-foundation";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.30-20260830-measure-engine-foundation");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
...
async function finishPendingCad(id){
  const [{restoreRecovery},{restoreCadRuntime,selectCad,beginCadPlacement}]=await Promise.all([
    import("./project-storage.js?v=0.8.30-20260830-measure-engine-foundation"),
    import("./cad.js?v=0.8.30-20260830-measure-engine-foundation")
  ]);
  restoreRecovery();
