import {startAR} from "./ar.js?v=0.8.21.7-20260829-1415";
import {$} from "./state.js?v=0.8.21.7-20260829-1415";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.21.7-20260829-1415");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
