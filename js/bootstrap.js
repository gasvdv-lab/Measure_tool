import {startAR} from "./ar.js?v=0.8.28.4-20260829-2145";
import {$} from "./state.js?v=0.8.28.4-20260829-2145";
const VERSION="0.8.28.4",BUILD="20260829-2145";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.28.4-20260829-2145");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
