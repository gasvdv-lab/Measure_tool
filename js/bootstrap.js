import {initPwaInstall} from "./pwa.js?v=0.8.36.4-20260830-ui-action-audit";
import {startAR,resumeARFromGesture} from "./ar.js?v=0.8.36.4-20260830-ui-action-audit";
import {$} from "./state.js?v=0.8.36.4-20260830-ui-action-audit";
const VERSION="0.8.36.4",BUILD="20260830-ui-action-audit";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.36.4-20260830-ui-action-audit");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
...
async function finishPendingCad(id){
  const [{restoreRecovery},{restoreCadRuntime,selectCad,beginCadPlacement}]=await Promise.all([
    import("./project-storage.js?v=0.8.36.4-20260830-ui-action-audit"),
    import("./cad.js?v=0.8.36.4-20260830-ui-action-audit")
  ]);
  restoreRecovery();
