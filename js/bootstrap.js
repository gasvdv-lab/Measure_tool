import {startAR,resumeARFromGesture} from "./ar.js?v=0.8.29.1.3-20260830-state-fix";
import {$} from "./state.js?v=0.8.29.1.3-20260830-state-fix";
const VERSION="0.8.29.1.3",BUILD="20260830-state-fix";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.29.1.3-20260830-state-fix");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
...
async function finishPendingCad(id){
  const [{restoreRecovery},{restoreCadRuntime,selectCad,beginCadPlacement}]=await Promise.all([
    import("./project-storage.js?v=0.8.29.1.3-20260830-state-fix"),
    import("./cad.js?v=0.8.29.1.3-20260830-state-fix")
  ]);
  restoreRecovery();
