import {startAR} from "./ar.js?v=0.8.25-20260829-1905";
import {$} from "./state.js?v=0.8.25-20260829-1905";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.25-20260829-1905");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
