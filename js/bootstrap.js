import {startAR} from "./ar.js?v=0.8.21.6-20260829-1408";
import {$} from "./state.js?v=0.8.21.6-20260829-1408";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.21.6-20260829-1408");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
