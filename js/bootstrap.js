import {initPwaInstall} from "./pwa.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {startAR,resumeARFromGesture} from "./ar.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
import {$} from "./state.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix";
const VERSION="0.8.36.4.1",BUILD="20260830-pwa-version-sync-fix";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
...
async function finishPendingCad(id){
  const [{restoreRecovery},{restoreCadRuntime,selectCad,beginCadPlacement}]=await Promise.all([
    import("./project-storage.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix"),
    import("./cad.js?v=0.8.36.4.1-20260830-pwa-version-sync-fix")
  ]);
  restoreRecovery();
