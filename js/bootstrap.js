import {startAR} from "./ar.js?v=0.8.12-20260822-2015";
import {$} from "./state.js?v=0.8.12-20260822-2015";
const VERSION="0.8.12",BUILD="20260822-2015";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.12-20260822-2015");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
