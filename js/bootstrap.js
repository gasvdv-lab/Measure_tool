import {startAR} from "./ar.js?v=0.8.19-20260823-0105";
import {$} from "./state.js?v=0.8.19-20260823-0105";
const VERSION="0.8.19",BUILD="20260823-0105";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.19-20260823-0105");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
