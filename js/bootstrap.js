import {startAR} from "./ar.js?v=0.8.13-20260822-2045";
import {$} from "./state.js?v=0.8.13-20260822-2045";
const VERSION="0.8.13",BUILD="20260822-2045";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.13-20260822-2045");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
