import {startAR} from "./ar.js?v=0.8.24-20260829-1805";
import {$} from "./state.js?v=0.8.24-20260829-1805";
...
async function lazyInitUI(){
  try{const mod=await import("./ui.js?v=0.8.24-20260829-1805");mod.initUI();if(document.documentElement.dataset.uiReady!=="1")throw new Error("UI-binding niet voltooid.");return true;}
