import {S,getShape,getPoint} from "./state.js?v=0.8.36-20260830-clearance-collision-2";
import {analyzeShapePoints,dispose} from "./geometry.js?v=0.8.36-20260830-clearance-collision-2";
